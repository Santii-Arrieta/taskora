  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Hemos enviado un enlace de confirmación a tu correo. Por favor, revisa tu bandeja de entrada para activar tu cuenta.",
        duration: 9000,
      });
      navigate("/login");
    } catch (error) {
      toast({
        ...
        description:
          error.message ||
          "No se pudo crear la cuenta. El email puede que ya esté en uso.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <Helmet>
        ...
        <meta
          name="description"
          content="Crea tu cuenta en Taskora y comienza a conectar con profesionales o a ofrecer tus servicios."
        />
      </Helmet>
