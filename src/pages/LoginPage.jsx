    ...
    try {
        ...
        if (error?.message.includes("Email not confirmed")) {
            toast({
                ...
                description: "Revisa tu bandeja de entrada y haz clic en el enlace de confirmación para activar tu cuenta.",
                variant: "destructive",
                duration: 9000
            });
        } else if (error?.message.includes("Invalid login credentials") || error?.message.includes("inválidas")) {
             toast({
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <Helmet>
        ...
        <meta name="description" content="Inicia sesión en Taskora para acceder a tu cuenta y conectar con profesionales." />
      </Helmet>
