-- Script para crear las funciones de verificación
...
BEGIN
  ...
  -- Crear notificación para el usuario (solo si la tabla notifications existe y tiene las columnas necesarias)
  BEGIN
